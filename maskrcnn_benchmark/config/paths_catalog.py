...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        # CityPersons
        "citypersons_train": {
            "img_dir": "citypersons/leftImg8bit/train",
            "ann_file": "citypersons/json_annotations/citypersons_train.json"
        },
        "citypersons_val": {
            "img_dir": "citypersons/leftImg8bit/val",
            "ann_file": "citypersons/json_annotations/citypersons_val.json"
        },
        "citypersons_test": {
            "img_dir": "citypersons/leftImg8bit/test",
            "ann_file": "citypersons/json_annotations/citypersons_test.json"
        }
    }
    ...
    def get(name):
        if "coco" in name:
            ...
            anno_dir = DatasetCatalog.ANNO_DIR
